                            ...
                            <ul class="mega-menu d-lg-flex">
                                ...
                                <li class="mega-menu-col col-lg-3">
                                    <ul>
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item active" href="portfolio-single-page-5.html">portfolio single Project 5</a></li>
...
<section class="banner_section parallax_bg overlay_bg2" data-parallax-speed="10" data-parallax-bg-image="assets/images/portfolio_signle_bg2.jpg">
    <div class="container"><!-- STRART CONTAINER -->
        <div class="row justify-content-center">
            <div class="col-xl-9 col-lg-12 col-sm-12 text-center">
                <div class="banner_content text_white">
                    <h2 class="animation text-uppercase" data-animation="fadeInUp" data-animation-delay="1s">expedita distinctio</h2>
	...
	<div class="container">
    	<div class="row align-items-center">
        	<div class="col-lg-6 col-md-12 mb-4 mb-lg-0 animation" data-animation="fadeInLeft" data-animation-delay="0.2s">
            	<img src="assets/images/portfolio_item22_540X676.jpg" alt="image">
            </div>
            <div class="col-lg-6 col-md-12 animation" data-animation="fadeInRight" data-animation-delay="0.2s">
                ...
                <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci sed quia, except to obtain some advantage from it?</p>
    ...
    <div class="container-fluid">
        <div class="row">
                	...
                	<div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-12 col-sm-6">
                            	<div class="icon_box icon_box_style_2 mt-2">
                                    <div class="box_icon">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 p-0 animation" data-animation="fadeInRight" data-animation-delay="0.4s">
                <div class="h-100 background_bg md-height-300" data-img-src="assets/images/portfolio_item19_960X640.jpg"></div>
            </div>
        </div>
    </div>
</section>
