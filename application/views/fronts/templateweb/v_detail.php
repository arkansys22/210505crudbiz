...
<!-- SITE TITLE -->
<title>Portfolio | Anger - Creative Business MultiPurpose HTML5 Template</title>
<!-- Favicon Icon -->
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span class="ion-android-menu"></span> </button>
      	<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav">
                        	...
                        	<ul class="mega-menu d-lg-flex">
                          	   <li class="mega-menu-col col-lg-3">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-4.html">Home - Business</a>
                                       </li>
                                       <li>
                ...
                <li class="dropdown dropdown-mega-menu">
                    <a class="dropdown-toggle nav-link active" href="#" data-toggle="dropdown">Portfolio</a>
                        <div class="dropdown-menu">
                            <ul class="mega-menu d-lg-flex">
                            	<li class="mega-menu-col col-lg-3">
                                    <ul>
                                ...
                                <li class="mega-menu-col col-lg-3">
                                    <ul>
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item active" href="portfolio-single-page-3.html">portfolio single Project 3</a></li>
                	...
                	<div class="cart_box dropdown-menu dropdown-menu-right">
                    	<ul class="cart_list">
                        	<li>
                            	...
                            	<a href="#"><img src="assets/images/cart_thamb1.png" alt="cart_thumb1"/>Variable product 001</a>
                                <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>78.00</span></span>
                            </li>
                            <li>
                            	<a href="#" class="item_remove"><i class="ion-close"></i></a>
                            	<a href="#"><img src="assets/images/cart_thamb2.png" alt="cart_thumb2"/>Ornare sed consequat</a>
    	...
    	<div class="row">
        	<div class="col-sm-12 text-center">
            	<div class="page-title">
            		<h1>corrupti quos dolores</h1>
                </div>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Portfolio</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Corrupti quos dolores</li>
                  </ol>
                </nav>
            </div>
        </div>
	...
	<div class="container">
    	<div class="row">
        	<div class="col-md-12 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
            	<img src="assets/images/portfolio_signle_bg2.jpg" alt="image">
            </div>
        </div>
        <div class="row">
        	<div class="col-md-12">
...
<section class="small_pt small_pb">
	<div class="container-fluid">
    	<div class="row">
        	<div class="col-md-12 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
            	<ul class="list_none carousel_slide4 owl-carousel owl-theme image_gallery gallery_hover_style1" data-margin="15" data-dots="false" data-autoplay="true" data-nav="true" data-rewind="true" data-autoplay-timeout="2500">
                    <li>
                    	<div class="image_gallery_item">
                            <a href="assets/images/portfolio_item1.jpg">
                            	<div class="gallery_img">
                                	<img src="assets/images/portfolio_item_small1_360X240.jpg" alt="image">
                                </div>
                    ...
                    <li>
                    	<div class="image_gallery_item">
                            <a href="assets/images/portfolio_item2.jpg">
                            	<div class="gallery_img">
                    ...
                    <li>
                    	<div class="image_gallery_item">
                        	<a href="assets/images/portfolio_item3.jpg">
                            	<div class="gallery_img">
                    ...
                    <li>
                    	<div class="image_gallery_item">
                            <a href="assets/images/portfolio_item4.jpg">
                            	<div class="gallery_img">
                            		<img src="assets/images/portfolio_item_small4_360X240.jpg" alt="image">
                                </div>
                                <div class="gallary_hover_box">
                                    <i class="ti-zoom-in"></i>
                                </div>
                    ...
                    <li>
                    	<div class="image_gallery_item">
                            <a href="assets/images/portfolio_item5.jpg">
                            	<div class="gallery_img">
                            		<img src="assets/images/portfolio_item_small5_360X240.jpg" alt="image">
                                </div>
                                <div class="gallary_hover_box">
                                    <i class="ti-zoom-in"></i>
                                </div>
                    ...
                    <li>
                    	<div class="image_gallery_item">
                            <a href="assets/images/portfolio_item6.jpg">
                            	<div class="gallery_img">
                            		<img src="assets/images/portfolio_item_small6_360X240.jpg" alt="image">
                                </div>
                                <div class="gallary_hover_box">
                                    <i class="ti-zoom-in"></i>
                                </div>
                    ...
                    <li>
                    	<div class="image_gallery_item">
                            <a href="assets/images/portfolio_item7.jpg">
                            	<div class="gallery_img">
                            		<img src="assets/images/portfolio_item_small7_360X240.jpg" alt="image">
                                </div>
                                <div class="gallary_hover_box">
                                    <i class="ti-zoom-in"></i>
                                </div>
                    ...
                    <li>
                    	<div class="image_gallery_item">
                            <a href="assets/images/portfolio_item8.jpg">
                            	<div class="gallery_img">
                            		<img src="assets/images/portfolio_item_small8_360X240.jpg" alt="image">
                                </div>
                                <div class="gallary_hover_box">
                                    <i class="ti-zoom-in"></i>
                                </div>
...
<section class="small_pt">
	<div class="container">
    	<div class="row">
        	<div class="col-xl-6 offset-xl-3 col-md-8 offset-md-2 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
            	<div class="heading_s1 text-center">
                	<h2>Process make difference</h2>
                </div>
                <p class="text-center">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
    	...
    	<div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 mt-3 mt-md-0 animation" data-animation="fadeInUp" data-animation-delay="0.8s">
